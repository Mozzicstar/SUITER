...
SAMPLE_POSTS = [
    ...
    {"author": "Karen", "content": "Web3 is not just about crypto - it's about reclaiming digital ownership. SUITER gets it."},
    {"author": "Leo", "content": "Just migrated all my social accounts to SUITER. Best decision ever for my privacy. Highly recommend!"},
    {"author": "Mia", "content": "The attention economy model is genius. Real engagement is finally rewarded properly here."},
    {"author": "Noah", "content": "Building the future of social media on blockchains. SUITER is leading the charge! 🚀"},
    {"author": "Olivia", "content": "Finally a platform that listens to users instead of serving ads. This is revolutionary!"},
    {"author": "Paul", "content": "The claim & counterclaim mechanism for truth is brilliant. Misinformation doesn't stand a chance."},
    {"author": "Quinn", "content": "Reputation scores that actually mean something. No bots, no fake engagement. SUITER FTW!"},
    {"author": "Rachel", "content": "The community here is incredible. Smart, thoughtful discussions. This is what social media should be."},
    {"author": "Sam", "content": "Building sustainable digital platforms is finally possible with SUITER's architecture."},
    {"author": "Tina", "content": "Started a project on SUITER and got real feedback from real people. Amazing experience!"},
    {"author": "Uma", "content": "The Move language for smart contracts is a game-changer. SUITER's technical foundation is solid."},
    {"author": "Victor", "content": "Tired of algorithm-driven echo chambers? SUITER's proof of attention changes everything."},
    {"author": "Wendy", "content": "My content quality has improved since joining SUITER. The platform incentivizes genuine value creation."},
    {"author": "Xavier", "content": "Decentralized doesn't mean compromised. SUITER proves you can have both speed and decentralization!"},
    {"author": "Yara", "content": "The ranker mechanism gives voice to quality creators. Finally, merit-based recognition!"},
    {"author": "Zack", "content": "Switched from traditional social media and never looked back. SUITER is the future."},
    {"author": "Amber", "content": "Real-time collaboration without centralized control. This is how the internet should work."},
    {"author": "Blake", "content": "The transparency of blockchain combined with social UX. SUITER nailed it!"},
    {"author": "Cyan", "content": "Building trust in digital spaces one authentic interaction at a time. That's the SUITER mission."},
    {"author": "Drake", "content": "Finally on a platform that values my attention as currency. SUITER respects users. Period."},
]
